                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <button
                        ...
                        className="flex-none flex items-center justify-center w-9 h-9 text-plum-soft hover:text-rose transition-colors"
                      >
                    ...
                    <div className="flex items-center justify-between mt-4">
                      ...
                      >
                        <button
                          ...
                          className="flex items-center justify-center w-10 h-10 text-plum disabled:opacity-40"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center justify-center w-10 h-10 text-plum"
                        >
